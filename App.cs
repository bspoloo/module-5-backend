...
using module_5_backend.Exercises.Activity_2;
using System;
...
namespace module_5_backend
{
    internal static class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("Delegates Activity: ");
            BasicDelegates delegates = new BasicDelegates();
            delegates.Run();

            Console.WriteLine("MulticastDelegates Activity: ");
